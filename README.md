...
skills, but also as a chance for you to reason about your implementation decisions. **Please fork this repository and
start committing your solution to your forked repository. For each features you should create a branch.**
...
## :heavy_check_mark: Marking Criteria **[Total 150 points]**
...
1. **As a Transport Dept. official/staff ability to -**
    - [ ] Open an account with the following information **[Mandatory feature | 5 points]**
        - [ ] Full name
        - [ ] Contact number
        - [ ] Implement OTP verification in the registration process
        - [ ] Account must be confirmed by the Higher Official or Support Team to access the portal
        - [ ] An official/staff can log in to their portal by
        ...
        - [ ] Create/Update stoppages with the following information **[Nice to have | 2 points]**
            ...
            - [ ] Label
            - [ ] Latitude & Longitude
        - [ ] Adjust transport demands manually for a specific route & timeslot for the following
...
2. **As a Consumer (ie: student, teacher, staff) ability to -**
    - [ ] Open an account with the following information **[Mandatory feature | 5 points]**
        ...
        - [ ] Account must be confirmed by the Higher Official or Support Team to access the portal
        - [ ] A consumer can log in to their portal by
            - [ ] Combination of username & password
            - [ ] Mobile number with OTP verification
